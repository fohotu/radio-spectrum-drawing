...
const [autoSaveDelay, setAutoSaveDelay] = useState(5);
...
useEffect(() => {
    ...
    }, [autoSave, autoSaveDelay, dirty, saving]);
   ...
   function exportPDF() {
    ...
    try {
        ...
        await axios.post(`/radiospectrum/update/${page.id}`, {
    ...
    const saveDocument1 = () => {
        ...
        form.action =`/radiospectrum/update/${page.id}`;
